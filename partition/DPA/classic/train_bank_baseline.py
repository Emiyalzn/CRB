...
def main(args):
    ...
    partition_name = f'partitions/bank/hash_portion{args.portion}_partition{args.num_partition}_overlap{args.overlap}.npy'
    ...
    checkpoint_filename = f'checkpoints/bank/model_{args.model}_partition_{args.num_partition}_portion_{args.portion}_overlap_{args.overlap}.pkl'
    evaluation_filename = f'evaluations/bank/model_{args.model}_partition_{args.num_partition}_portion_{args.portion}_overlap_{args.overlap}.pkl'
